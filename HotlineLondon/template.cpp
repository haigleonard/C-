...
void display()									
{
	...
	float top_color[3] ={1.0,0.0,0.0};
	float bottom_color[3] ={0.0,1.0,1.0};
	myfont.Begin();
	...
	myfont.DrawString("The quick brown fox jumps over the lazy dog", 0.6f, 60.0f, 360.0f, top_color, bottom_color);
	myfont.DrawString("fifty five", 1.0f, 20.0f, 320.0f);
	myfont.DrawString("The quick brown fox jumps over the lazy dog", 4.0f, 20.0f, 280.f, top_color, bottom_color);
